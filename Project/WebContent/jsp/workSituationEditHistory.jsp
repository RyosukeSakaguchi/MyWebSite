...
<body>
	...
	<section id="fh5co-projects">
		...
		<div class="container" style="width: 100%;">
			...
			%>
			<div aline="center"><%=name%>の編集履歴${dispMsg}</div><br><br>
								...
								<div>
									<table class="table table-striped">
										...
										<tbody>
											...
											%>
											<tr>
												<td><%=workSituationEditList.get(i).getEditDate()%></td>
												<td><%=workSituationEditList.get(i).getEditContent()%></td>
											</tr>
											<%
													if(i == 0){
														break;
									...
									<ul class="pull-center center-menu">
										<%
											if(result){
										%>
